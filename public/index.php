...
<body class="bg-white text-gray-800 font-sans leading-normal">
    ...
    <nav class="sticky top-0 bg-white shadow-md z-50">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="space-x-6">
                ...
                <a href="#contact" class="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 transition">Contact Us</a>
            </div>
        </div>
    </nav>
    ...
    <header class="bg-gradient-to-br from-blue-500 to-blue-700 text-white py-20">
        <div class="container mx-auto px-4 flex items-center">
            <div class="w-1/2 pr-10">
                <h1 class="text-5xl font-bold mb-6">Your Global Education Journey Starts Here</h1>
                <p class="text-xl mb-8">Confused about your next study destination? We're on a mission to help you make the best out of your life. Your bright future is our priority.</p>
            ...
            <div class="w-1/2">
                <img src="https://img.freepik.com/free-photo/young-student-working-assignment_23-2149257177.jpg?t=st=1734312110~exp=1734315710~hmac=30294f23749b426d086cbb521d218d9550e02154472712740483c54c031fc83a&w=740" alt="Student Studying" class="rounded-xl shadow-2xl">
            </div>
        </div>
    </header>
     ...
     <section id="achievements" class="bg-blue-50 py-16">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-bold text-blue-800">Our Achievements</h2>
                <p class="text-xl text-gray-600 mt-4">A testament to our commitment and success</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8" id="achievementGrid">
    ...
    <script>
        ...
        const achievements = [
            ...
            { label: 'Admitted Students', value: 500 },
            { label: 'Partner Agents', value: 50 },
            { label: 'Travelers Helped', value: 100 },
            { label: 'Jobs Secured', value: 45 }
        ];
        ...
        function createAchievementItems() {
            ...
            achievements.forEach((achievement, index) => {
                ...
                achievementElement.innerHTML = `
                    <div class="achievement-value text-5xl font-bold text-blue-600 mb-4" data-target="${achievement.value}">0+</div>
                    <div class="text-xl text-gray-700">${achievement.label}</div>
                `;
    ...
    <section id="services" class="container mx-auto py-20 px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold mb-4">Our Educational Services</h2>
            <p class="text-xl text-gray-600">Comprehensive support for your global education journey</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white shadow-lg rounded-xl p-8 text-center hover:shadow-2xl transition">
                ...
                <h3 class="text-2xl font-semibold mb-4">Study Abroad</h3>
            ...
            <div class="bg-white shadow-lg rounded-xl p-8 text-center hover:shadow-2xl transition">
                ...
                <h3 class="text-2xl font-semibold mb-4">Visa Assistance</h3>
            ...
            <div class="bg-white shadow-lg rounded-xl p-8 text-center hover:shadow-2xl transition">
                ...
                <h3 class="text-2xl font-semibold mb-4">Accommodation</h3>
    ...
    <section class="bg-gray-100 py-20">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600">Students who transformed their futures with us</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
    ...
    <section id="contact" class="container mx-auto py-20 px-4">
        <div class="bg-blue-600 text-white rounded-xl p-16 flex items-center">
            <div class="w-1/2 pr-10">
                <h2 class="text-4xl font-bold mb-6">Ready to Start Your Journey?</h2>
                <p class="text-xl mb-8">Book a free consultation with our expert counselors and take the first step towards your global education dream.</p>
                <div class="flex items-center space-x-4">
                    <i data-feather="phone" class="text-white" width="32" height="32"></i>
                    <span class="text-2xl font-semibold">+86 188 64506806</span>
                </div>
                <div class="flex items-center space-x-4 mt-4">
                    <i data-feather="mail" class="text-white" width="32" height="32"></i>
                    <span class="text-xl">teterestral@gmail.com</span>
                </div>
            </div>
            <div class="w-1/2">
                <form class="bg-white p-8 rounded-xl shadow-2xl">
                    <h3 class="text-2xl font-semibold mb-6 text-gray-800">Schedule Your Consultation</h3>
                    <div class="mb-4">
